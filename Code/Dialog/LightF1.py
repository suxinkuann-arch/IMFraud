...
model_f1_scores = {
    "Qwen3-0.6B": [0.9872, 0.9445, 1.0000, 0.9826, 0.9836, 0.9913],  # Fraud1-Fraud6
    "Qwen3-1.7B": [0.9873, 0.9691, 0.9927, 0.9778, 0.9876, 0.9978],
    "Qwen3-4B": [0.9952, 0.9734, 1.0000, 0.9948, 0.9937, 0.9978],
    "Qwen3-8B": [0.9935, 0.9626, 0.9723, 0.9877, 0.9877, 0.9889]
}
